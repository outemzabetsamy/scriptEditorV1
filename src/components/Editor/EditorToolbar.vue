<template>
  <div class="editor-toolbar">
      ...
      <div class="nav">
          <div v-for="(tool,ind) in tools" :key="ind" class="nav-item">
              <div v-if="tool.type==='select'">
                  <select v-model="tool.action" class="select px:width-15" @change="selectType(tool.action)">
                      <option v-for="option in tool.options" :key="option" :value="option.value">
                          {{option.text}}
                      </option>
                  </select>
              ...
              <div v-if="tool.type ==='toggle'">
                  <span v-for="(button,order) in tool.buttons" :key="order">
                    <button v-if="button.icon!=null" v-html="button.icon" :title="button.text" :id="button.value" type="button" class="buton" @click="toggleButton(ind,button,order)"> </button>
                    <button v-else type="button" class="buton" :id="button.value" @click="toggleButton(ind,button,order)"> 
                        {{button.text}}
                    </button>
               ...
               <div v-if="tool.type==='alignement'">
                  <select v-model="tool.action" class="alignement px:width-15" @change="selectAlignement(tool.action)">
                      <option v-for="option in tool.options" :key="option" :value="option.value">
                          {{option.text}}
                      </option>
                  </select>
            ...
            <div v-if="tool.type ==='wrap'">
                  <span v-for="(button,order) in tool.buttons" :key="order">
                    <button v-if="button.icon!==null" v-html="button.icon" :title="button.text" type="button" class="buton" @click="wrapButton(ind,button,order)"> </button>
                    
                        <button v-else type="button" class="buton" @click="wrapButton(ind,button,order)"> 
                        {{button.text}}
                    </button>
                 ...
                 <div v-if="tool.type ==='button'">
                    ...
                    <button v-if="tool.icon!==null" v-html="tool.icon" :title="tool.text" type="button" class="buton" @click="singleButton(tool.action)"> </button>
